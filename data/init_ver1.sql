...
--
-- Máy chủ: db:3306
-- Thời gian đã tạo: Th12 24, 2024 lúc 07:29 AM
...
CREATE TABLE `chapters` (
  ...
  `is_hot` int NOT NULL COMMENT 'độ hot của chaper'
...
ALTER TABLE `stories`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `id` (`id`),
  ADD KEY `idx_stories_title` (`title`),
  ADD KEY `idx_stories_view_count` (`view_count`),
